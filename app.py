...
/* Headings without default Streamlit box */
.custom-h1 {
    text-align: center;
    color: #c2185b;
    font-size: 3rem;
...
page = st.sidebar.radio(
    ...
    index=["Home", "Cost Estimator", "How It Works", "Insights & Factors", "About the Project"].index(st.session_state.page)
)
...
if page == "Home":
    ...
    st.markdown("""
Healthcare insurance costs are influenced by personal characteristics, health metrics, and lifestyle habits.
Accurately estimating these costs can be challenging for individuals planning their healthcare expenses.
